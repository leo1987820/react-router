 ...
 * @license MIT
 */
import { g as preloadVite, h as getVite, l as loadConfig, n as watch, t as run$1 } from "../typegen-DJqo-Jxk.js";
...
async function build(root, options = {}) {
	...
	let { build } = await import("../build-qb8IRs0K.js");
...
async function dev(root, options = {}) {
	let { dev } = await import("../dev-BUWJD_ei.js");
	if (options.profile) await start();
